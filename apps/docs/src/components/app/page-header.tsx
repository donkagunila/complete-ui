...
const PageHeader = ({title, description, className}: IPageHeaderProps) => {
    return (
        <div className={twMerge(["mt-8 sm:mt-16", className])}>
            <h2 className="font-semibold leading-7 text-primary">Complete UI</h2>
            <h1 className="mt-4 mb-2 max-w-2xl text-3xl font-extrabold tracking-tight text-slate-900 sm:text-4xl">{title}</h1>
            {description && (
